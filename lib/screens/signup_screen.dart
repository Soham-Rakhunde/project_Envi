                        ...
                        children: [
                          ...
                          Expanded(
                            ...
                            child: Padding(
                              ...
                              child: buildFormField("Username",userController,false),
                            ),
                          ),
                          const Spacer(
                            flex:2,
                              ...
                              onPressed: (()  {
                                setState(() async {
                                  try {
                                    ...
                                    print(await context.read(userIdProvider));
                                    await context.read(leaderCollection)
                                        .doc(context.read(userIdProvider).state)
                                        .set({
                                          'coins': 0,
                                          'score': 0,
                                          'username': userController.text
                                         });
                                    context.read(usernameProvider).state = userController.text;
